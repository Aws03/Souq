...
public class QuotaRuleTests
{
    ...
    private static readonly HashSet<string> ReviewedCountThenWrite = new(StringComparer.Ordinal)
    {
        ...
        // ============================================================================
        // C9 (ADR-0050 §6): تجميعُ أحداث يومٍ يقرأ صفوف التجميع القائمة لذلك اليوم ثم يُدخل ما
        // ينقص. **وليس حدّاً تجارياً**: لا شيء يُرفض هنا بناءً على العدّ — لا حصّة ولا سقف — فلا
        // يوجد ما يفشل مفتوحاً. ما يمكن أن يقع هو صفٌّ مكرَّر لو عمل المُجمِّع مرّتين لليوم نفسه،
        // **والفهرس الفريد على (متجر، يوم، منتج) يرفضه** فتفشل الدورة وتُعاد — لا رقمٌ مضاعف
        // يُكتب. والمُجمِّع مَسْحٌ أحاديُّ النسخة أصلاً.
        //
        // فالفرق عن الحالات أعلاه: هناك عدٌّ **يقرّر**، وهنا عدٌّ **يُحصي**.
        // ============================================================================
        "Souq.Infrastructure.Persistence.EventRollups",
    };

...
public class SearchAnalyticsTests
{
    ...
    // ========================================================================
    // المسح يُفرغ ما تجاوز المدّة، لا دفعةً منه (M15 — عيبٌ في M13 نفسه).
    //
    // كانت الدورة تحذف دفعةً واحدة (5000) كل ستّ ساعات: عشرون ألف صفٍّ في اليوم للمتجر. ومسار الكتابة
    // نقطةٌ عامّة بلا حدّ معدّل تكتب صفّاً لكل بحث. فالجدول ينمو أسرع ممّا يُنظَّف بمراتب، و"تسعون
    // يوماً" التي وثّقتها تلك المرحلة لم تكن مضمونة تحت أي حمل.
    //
    // يُفحص بحجم دفعةٍ صغير لا بخمسة آلاف صفّ: المقصود هو **أنّ الدورة تُكرّر حتى تفرغ**، وذلك يظهر
    // بدفعةٍ من اثنين وخمسة صفوف كما يظهر بخمسة آلاف — وبلا اختبارٍ يستغرق دقائق ويحجز الذاكرة.

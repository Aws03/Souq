...
{
    private static readonly TenantInfo StoreA = new(1, "store-a", "A", TenantStatus.Active, "JOD", "ar", "Asia/Amman");
    private static readonly TenantInfo StoreB = new(2, "store-b", "B", TenantStatus.Active, "USD", "en", "UTC");

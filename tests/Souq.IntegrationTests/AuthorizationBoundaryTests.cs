...
public class AuthorizationBoundaryTests
{
    private static readonly HashSet<string> ReviewedPublicEndpoints = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        // ========================================================================
        // التقاطُ سلوك المتصفّح (C9b): مجهولةٌ بقرار — الزائرُ غير المسجَّل هو أكثرُ مَن يتصفّح،
        // وقياسٌ لا يراه إلّا المسجَّلون يقيس الأقلّية.
        //
        // وما يجعلها مقبولةً في هذه القائمة أنّها **لا تعيد شيئاً**: لا قراءةَ تُستنزف منها، ولا
        // جوابَ يكشف حالة المتجر (202 سواءٌ التُقط أم لا). وما يصل منها معرّفاتٌ ومواضع؛ السعرُ
        // وحالةُ التوفّر يقرؤهما الخادم — فلا يكتب مجهولٌ رقماً مالياً في جدول.
        // وهي خلف حدّ معدّلٍ خاصّ بها، لأنّ الضرر المتصوَّر منها حجمٌ لا تسريب.
        // ========================================================================

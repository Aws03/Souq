  ...
  return (
    <div className={styles.line}>
      ...
      <div className={styles.info}>
        ...
        <div className={styles.unit}>{formatPrice(item.price, item.currency)} / للقطعة</div>
      </div>
      ...
      <button type="button" className={styles.remove} onClick={() => onRemove(item.id)} aria-label={`إزالة ${item.name}`}>
        <TrashIcon />
      </button>
    </div>
  );

...
import { CardIcon, GridIcon, MoonIcon, PackageIcon, PercentIcon, ReceiptIcon, SunIcon, TeamIcon } from '../components/icons/Icons';
...
export const PLATFORM_NAV = [
  ...
  // ملفّات الضريبة (ADR-0055): بصلاحية إعدادات المنصّة — إعدادٌ واحد يخدم كل المتاجر.
  { to: '/platform/tax', label: 'platform.nav.tax', icon: PercentIcon, permission: 'platform.settings.manage' },

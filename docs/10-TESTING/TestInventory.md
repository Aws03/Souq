...
| `tests/Souq.IntegrationTests/PaymentAdapterTests.cs` | `SecretProtectorTests`, `DemoPaymentGatewayTests` | 9 | 2 |
...
| `tests/Souq.IntegrationTests/RecommendationTests.cs` | `RecommendationTests` | 3 | 0 |

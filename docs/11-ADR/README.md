...
- ADRs are numbered sequentially and never renumbered. The next one is **0057** (0047–0052 are the commercial-platform set, written 2026-09-20; 0053 was added by C1 and 0054 by C2 as each implemented them; 0055 records the owner's `P-06` answer of 2026-09-21, and 0056 was written and implemented by C5 on 2026-09-22; before them this line said 0047, and before 2026-09-20 it still said 0043 while 0043–0046 already existed — a record written from a stale line collides silently, so update it in the same commit that adds a record).

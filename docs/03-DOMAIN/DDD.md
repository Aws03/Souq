...
| `Product` (Catalog) | variants, images, translations | slug and SKU unique per store; exactly one default variant; status lifecycle; price in the store currency | `rowversion` |

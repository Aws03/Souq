...
| C1 | Oversell / lost updates | ✅ `rowversion` on Products, Coupons, Orders; conflicts become 409 | Integration: two contexts selling the last unit; 8 parallel checkouts never oversell; 5 parallel checkouts on a single-use coupon create one order (Phase 10) |

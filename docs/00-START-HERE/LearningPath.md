...
- Phase 16 (Storefront) is 🟡: product variants can't be chosen yet. P-08 is decided and the groundwork (V1) is built; the option model (V2) and the storefront selection (V3) remain ([ProductVariants.md](../04-MODULES/Catalog/ProductVariants.md)).

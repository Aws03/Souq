...
| ~~P-08~~ | ~~Product variants: structured options or labels, how multi-variant prices show in lists, and how a variant is chosen~~ | **Decided 2026-09-17** ([ADR-0039](../11-ADR/0039-product-variants-order-identity.md)); V1, V2 and V3 built ([ADR-0040](../11-ADR/0040-product-option-model.md), [ADR-0041](../11-ADR/0041-storefront-variant-selection.md)); V4 reporting remains ([ProductVariants.md](../04-MODULES/Catalog/ProductVariants.md)) |

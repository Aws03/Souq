...
### Phase 17: Tenant admin dashboard 🔶 *(was 16)* — the KPI half delivered
- **Scope.**
  ...
  - Back-office screens for everything built in Phases 5–14. **Remaining.**
  - Store settings, staff, and permissions. **Remaining** as screens; the API exists.
  - Confirmation dialogs and server-paged data tables. **Remaining.**
- **Exit criteria.** A tenant admin can run a store without ever using Swagger. **Not met:** the dashboard is there, the editing screens for settings and staff are not.

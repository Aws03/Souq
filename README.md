...
- **Not built yet:** choosing a product variant in the storefront (Phase 16 🟡; P-08 decided and the groundwork built, the option model and storefront selection remain — [ProductVariants.md](docs/04-MODULES/Catalog/ProductVariants.md)), the storefront preview and platform-wide settings (Phase 18 🟡, waiting on D-22 and P-07), and roadmap Phases 19–23. Current status: [ProductRoadmap.md](docs/12-ROADMAP/ProductRoadmap.md).

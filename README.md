...
- **Operations gaps:** no CI pipeline; backups are rehearsed but not scheduled or off-site ([BackupAndRestore.md](docs/09-OPERATIONS/BackupAndRestore.md)); nothing outside the stack watches the health endpoints.

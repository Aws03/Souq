...
public enum EmailTemplate
{
    ...
    PasswordChanged,
    // C6 (ADR-0058): تذكيرُ التاجر بفاتورة اشتراكٍ استحقّت ولم تُسدَّد. يقول ما عليه ومتى، ولا
    // يحمل رابطَ دفعٍ — التحصيلُ حوالةٌ بقرار `C-15`، فزرٌّ يَعِد ببوّابةٍ يَعِد بما لا يوجد.
    InvoiceOverdue,
}

...
public interface ITaxCalculator
{
    ...
    // ============================================================================
    // الاحتسابُ نفسُه لاختيارٍ يُمرَّر بدل اختيارِ متجر السياق (C5، [ADR-0056](0056)).
    //
    // **ولماذا وسيطان بدل قراءةٍ ثانية؟** لأنّ المُصدِر في فاتورة الاشتراك هو **سوق** لا المتجر:
    // الضريبةُ تتبع اختصاص المنصّة، واختيارُها يعيش في إعداد فوترتها. ولو قرأ هذا المنفذُ ذلك
    // الإعدادَ بنفسه لصارت وحدةُ الضريبة تعتمد على وحدة الفوترة — والسهمُ عكسيّ: الفوترةُ هي من
    // يستهلك الضريبة، لا العكس. فيمرّر المُنادي ما اختاره، ويبقى الحسابُ والتقريبُ وبوّابةُ
    // التحقّق في **موضعٍ واحد** لا اثنين.
    //
    // وهي البوّابةُ نفسها حرفياً: فاتورةُ منصّةٍ تحت إصدارٍ لم يتحقّق منه مهنيّ **لا تُضرَّب**،
    // تماماً كسلّة متسوّق.
    // ============================================================================
    Task<TaxQuote> QuoteForProfileAsync(

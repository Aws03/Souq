    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlyDictionary<EmailTemplate, TemplateText>> Texts =
        new Dictionary<string, IReadOnlyDictionary<EmailTemplate, TemplateText>>
        {
            ["ar"] = new Dictionary<EmailTemplate, TemplateText>
            {
                ...
                [EmailTemplate.PasswordChanged] = new("تغيّرت كلمة مرور حسابك", "تغيّرت كلمة مرور حسابك",
                    "تغيّرت كلمة مرور حسابك للتوّ، وأُنهيت كل الجلسات المفتوحة. إن كنت أنت من غيّرها فلا حاجة لأي إجراء.",
                    "لم أُغيّرها — استعِد حسابي",
                    "إن لم تكن أنت، استعِد حسابك فوراً من الزرّ أعلاه وراجع بريدك المسجَّل."),
                [EmailTemplate.InvoiceOverdue] = new("فاتورة {invoiceNumber} مستحقّة", "فاتورة اشتراكٍ مستحقّة",
                    "فاتورةُ اشتراكك رقم {invoiceNumber} بمبلغ {outstanding} استحقّت منذ {daysOverdue} يوماً. يرجى تحويل المبلغ بحسب تعليمات الدفع في لوحتك.",
                    "عرض الفاتورة",
                    "إن كنت قد حوّلت المبلغ للتوّ فتجاهل هذه الرسالة — قد لا يكون السداد قد سُجّل بعد."),
            ...
            ["en"] = new Dictionary<EmailTemplate, TemplateText>
            {
                ...
                [EmailTemplate.PasswordChanged] = new("Your password was changed", "Your password was changed",
                    "Your account password was just changed, and every open session was signed out. If that was you, there is nothing to do.",
                    "That wasn't me — recover my account",
                    "If this wasn't you, recover your account straight away using the button above and check your registered email."),
                [EmailTemplate.InvoiceOverdue] = new("Invoice {invoiceNumber} is overdue", "A subscription invoice is due",
                    "Your subscription invoice {invoiceNumber} for {outstanding} fell due {daysOverdue} days ago. Please transfer it using the payment instructions in your dashboard.",
                    "View invoice",
                    "If you have just sent the transfer, ignore this email — it may not be recorded yet."),

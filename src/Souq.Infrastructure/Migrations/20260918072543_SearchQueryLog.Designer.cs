...
namespace Souq.Infrastructure.Migrations
{
    ...
    [Migration("20260918072543_SearchQueryLog")]
    partial class SearchQueryLog
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Souq.Domain.Entities.SearchQueryLog", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("TenantId", "Culture", "TermNormalized"), new[] { "ResultCount" });

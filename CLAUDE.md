...
> **اقرأ [AGENTS.md](AGENTS.md) أولاً:** عقد المستودع الكامل — القواعد الصارمة وما يفرضها من اختبارات، وما يجب فحصه قبل
> أي تعديل، وأوامر بوّابة الجودة، ومتى تتوقّف وتسأل. وخريطة التوثيق كلها في [docs/README.md](docs/README.md).
> هذا الملف يضيف تفضيلات العمل الشخصية فقط.
